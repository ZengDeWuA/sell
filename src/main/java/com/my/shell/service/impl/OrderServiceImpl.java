...
import com.my.shell.converter.OrderMaster2OrderDTOConverter;
import com.my.shell.dao.OrderDetailRepository;
import com.my.shell.dao.OrderMasterRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderDTO create(OrderDTO orderDTO) {
        ...
        BigDecimal orderAconut = new BigDecimal(BigInteger.ZERO);
        ...
        for (OrderDetail orderDetail:orderDTO.getOrderDetailList()
            ...
            //计算总价
            orderAconut = productInfo.getProductPrice().multiply(new BigDecimal(orderDetail.getProductQuantity()))
                    .add(orderAconut);
            //订单详情入库
        ...
        orderMaster.setOrderAmount(orderAconut);
